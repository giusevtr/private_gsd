import jax.random
from models import PrivGA, SimpleGAforSyncData, RelaxedProjection
...
if __name__ == "__main__":
    ...
    hs_module = Halfspace(domain=data.domain, k_cat=1, cat_kway_combinations=[('ESR',)], rng=rng, num_random_halfspaces=2000)
    rng = jax.random.PRNGKey(0)
