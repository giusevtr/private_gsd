...
if __name__ == "__main__":
    ...
    parser.add_argument('--rounds', type=int, default=[10, 20, 30, 40, 50, 60], nargs='+')
    parser.add_argument('--samples_per_round', type=int, default=[10], nargs='+')

    args = parser.parse_args()

    run_acs_mixed(args.algo, args.queries, args.task, args.epsilon, args.seed, args.adaptive, args.rounds,
