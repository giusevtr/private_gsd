...
if __name__ == "__main__":
    ...
    algo = GeneticSD(num_generations=80000, print_progress=False, stop_early=True, strategy=GeneticStrategy(domain=data.domain, elite_size=5, data_size=2000))
    ...
    # for eps in [0.07, 0.23, 1.0]:
        ...
        # for seed in [0]:
            ...
            sync_data.df.to_csv(f'sync_data/privga_{dataset_name}_sync_{eps:.2f}_{seed}.csv', index=False)
