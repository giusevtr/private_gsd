...
if __name__ == "__main__":
    ...
    # module1 = HalfspaceDiff.get_kway_random_halfspaces(data.domain, k=1, rng=key, random_hs=100000)
    module1 = HalfspaceDiff(domain=data.domain, k_cat=1, cat_kway_combinations=[('PINCP',), ('PUBCOV',),('ESR', )], rng=key,
