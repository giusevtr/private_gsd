...
if __name__ == "__main__":
    ...
    module1 = Prefix(data.domain, k_cat=1, cat_kway_combinations=[('PINCP', )], rng=key, k_prefix=2, num_random_prefixes=50000)
    ...
    # for eps in [0.07, 0.23, 0.52, 0.74, 1.00]:
        ...
        # for seed in [0, 1, 2]:
            for rounds in [50]:
                ...
                t0 = timer()
                sync_dir = f'sync_data/{dataset_name}/PrivGA/Prefix/{rounds}/{num_sample}/{eps:.2f}/'
                ...
                print(f'PrivGA: ({dataset_name}) eps={eps:.2f}, seed={seed}'
