...
from stats import ChainedStatistics, Halfspace, HalfspaceDiff, Prefix, PrefixDiff
...
if __name__ == "__main__":
    ...
    module = PrefixDiff.get_kway_prefixes(data.domain, k_cat=1, k_num=2,
                                          rng=key, random_prefixes=1000)
    ...
    algo = RelaxedProjectionPP_v2(domain=data.domain, data_size=1000, iterations=1000,
                               learning_rate=[0.003], print_progress=True)
