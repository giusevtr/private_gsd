...
import pandas as pd
import os
from models import PrivGA, PrivGAV2, PrivGAJit
...
def run(dataset_name, seeds=(0, 1, 2), eps_values=(0.07, 0.23, 0.52, 0.74, 1.0)):
    ...
    algo = PrivGAV2(num_generations=1000000,
...
if __name__ == "__main__":
    ...
    for data in DATA:
        # results_temp = run(data, eps_values=[1.0, 0.74, 0.52, 0.23, 0.07], seeds=[0, 1, 2, 3, 4])
