...
class RelaxedProjectionPP_v2(Generator):
    ...
    def __init__(self, domain, data_size, iterations=1000,
        ...
        self.learning_rate = [0.0001, 0.0002, 0.0003, 0.0004,
    ...
    def fit(self, key, adaptive_statistic: ChainedStatistics, init_data: Dataset=None, tolerance=0, adaptive_epoch=1):
        ...
        for i, param in enumerate(start_params):
            new_param = self.fit_help(param, compute_loss_jit, update_fn_jit, clip_numeric, self.learning_rate)
    ...
    def fit_help(self, params, compute_loss_jit, update_fn_jit, post_fn, learning_rates: list):
        ...
        for lr in learning_rates:
            ...
            for i in range(13):
                ...
                for t in range(self.iterations):
                    ...
                    real_loss = compute_loss_jit(temp_params, 2**15)
                    if real_loss < best_loss - 1e-7:
                        best_loss = real_loss
                ...
                if self.print_progress:
                    ...
                    timer(t_sigmoid, f'\t\t\tEnd training at t={t}. Final total_loss={this_loss:<8.8f}, '
                                     f'best_loss={best_loss:8.8f}. time=')
