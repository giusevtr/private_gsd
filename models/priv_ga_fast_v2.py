...
class SimpleGAforSyncDataFast:
    ...
    def ask_strategy(self, rng: chex.PRNGKey, eval_stats_vmap, state):
        rng, rng_a, rng_b, rng_mate = jax.random.split(rng, 5) # no rng2
        ...
        A_stats = state.archive_stats[idx_a]
        B_stats = state.archive_stats[idx_b]
