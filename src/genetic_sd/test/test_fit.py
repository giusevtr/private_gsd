...
from src.genetic_sd.utils import Dataset, Domain
from src.genetic_sd.utils.statistics import _get_mixed_marginal_fn, _get_bin_edges, _get_density_fn, get_quantiles
...
class TestFit(unittest.TestCase):
    ...
    def test_mixed_columns_fit(self):
        ...
        # print(synth.sample())
        max_error = np.abs(synth.stat_fn(synth.data) - synth.stat_fn(synth.sync_data)).max()
