...
import chex
from genetic_sd.utils import Dataset, Domain,  ColumnAttribute, DataType
from genetic_sd.adaptive_statistics import AdaptiveStatisticState
from tqdm import tqdm
import numpy as np


class FasatMarginals(AdaptiveStatisticState):

    def __init__(self, domain: Domain,
                 kway_combinations: list,
                 k: int,
    ...
    def get_all_kway_combinations(domain: Domain, k: int, tree_query_depth: int = 3, max_workload_size: int =None,
        ...
        return FasatMarginals(domain, kway_combinations, k, tree_query_depth=tree_query_depth, num_cols_thresholds=num_cols_thresholds)
    ...
    def get_all_kway_mixed_combinations_v1(domain, k):
        ...
        return FasatMarginals(domain, kway_combinations, k)
